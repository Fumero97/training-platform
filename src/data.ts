    ...
    subModules: [
      ...
      { 
          ...
          sections: [
              ...
              {
                  title: 'Why it is important',
                  content: '<p>As a manager it is your responsibility to ensure that expenditure falls within the budget set out by your Programme Manager at the start of the summer. Managing a budget is about balance, planning and organisation.</p>'
              },
              {
                  title: 'Expenses',
                  isAccordion: true,
      ...
      { 
          ...
          sections: [
              {
                  title: 'What it is',
                  content: '<p>A schedule of working hours for all members of the team (Management, Campus and Tour Team)</p>'
              },
              {
                  title: 'Why it is important',
    ...
    subModules: [
      ...
      { id: '2.3', title: '2.3 Academics', sections: [
          ...
          },
          {
              title: 'Absences',
              isAccordion: true,
              content: '<p>You will need to set up group WhatsApp with the Centre Manager, Director of Studies, Senior Teacher, and all teachers.</p><p>If a student is absent from class, they will message that group and it is your responsibility to investigate and report back in the group. For more on absences, see the Language in Action Staff Handbook.</p>'
          },
          {
          ...
          },
          {
              title: 'Concerns',
              isAccordion: true,
              content: '<p>If there are any concerns about a student\’s behaviour or welfare in the classroom, the teacher will speak to the Centre Manager, who will need to investigate the concern. For more information see section <a href="/contents/4.0">4.0 Safeguarding & Welfare</a>, and the Language in Action Employee Handbook</p>'
          }
      ] },
          ...
          id: '4.2', 
            ...
            sections: [
                ...
                },
                {
                    ...
                    isAccordion: true,
                    content: '<p>For more information on disability management and policies, see the Language in Action Staff Handbook.</p>'
                }
            ] 
        },
